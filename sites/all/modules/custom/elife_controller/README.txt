...
Here is an example of how to enable the Rules module by using the update hook in the elife_controller.install file:

/**
 * Enabling Rules module
 */
function elife_controller_update_7000()
{
  $modules = array('rules');
